...
namespace ce103_hw3
{
    internal class LbrrnMain
    {
        ...
        private void LbrrnBooks()
        {
            ...
            string[] booksOptions = { "Add a new book", "Edit an exinsting book", "Delete an existing book", "List all books", "Search a specific book" };
        ...
        private void LbrrnPeople()
        {
            ...
            string[] peopleOptions = { "Add a person borrowing book and what book they borrowed", "Update a previous person's status", "List people borrowed books from this library" };
